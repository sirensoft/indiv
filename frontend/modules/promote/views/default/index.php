...
<div class="promote-default-index">
    ...
    <ol>
        ...
        <li>
            <?= Html::a('ร้อยละหญิงตั้งครรภ์ที่ได้รับการดูแลก่อนคลอด 5 ครั้ง ตามเกณฑ์คุณภาพ', ['/promote/default']) ?>            
        </li>
        ...
        <li>
            <?= Html::a('ร้อยละของทารกแรกเกิดน้ำหนักน้อยกว่า 2,500 กรัม', ['/promote/default']) ?>            
        </li>
        <li>
