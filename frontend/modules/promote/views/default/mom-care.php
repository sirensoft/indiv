...
$this->title = 'ร้อยละของหญิงหลังคลอดได้รับการดูแลครบ 3 ครั้งตามเกณฑ์';
...
<div class="patient-search" style="margin-bottom: 10px">
    ...
    $form = ActiveForm::begin([
                'action' => ['/promote/default/mom-care'],
                'method' => 'get',
    ]);
    ?>
...
echo GridView::widget([
    ...
    'panel'=>[
        'before'=>'<a href="https://goo.gl/AJKx2A" target="_blank">[ดูผลรวม-คลิก]</a>',
        'heading'=>'รายชื่อ'
    ],
    'columns' => [      
        [
        ...
        'g:integer:ครรภ์ที่',
        'bdate:date:คลอด',
        'c1:text:เยี่ยมครั้งที่1',
         'c2:text:เยี่ยมครั้งที่2',
         'c3:text:เยี่ยมครั้งที่3',
